...
namespace NBNW.Dataflow
{
	...
	/// </summary>
	internal partial class DataflowDocData : DataflowDocDataBase
	{
		/// <summary>
		/// Constructs a new DataflowDocData.
		/// </summary>
		public DataflowDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Dataflow document in memory.
	/// </summary>
	internal abstract partial class DataflowDocDataBase : DslShell::ModelingDocData
	{
		...
		/// <summary>
		/// Constructs a new DataflowDocDataBase.
		/// </summary>
		protected DataflowDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(DataflowExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::NBNW.Dataflow.DataflowDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::NBNW.Dataflow.DataflowDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::NBNW.Dataflow.FlowGraph modelRoot = null;
			...
			global::NBNW.Dataflow.DataflowDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::NBNW.Dataflow.DataflowSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, this.ValidationController, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::NBNW.Dataflow.FlowGraph modelRoot = (global::NBNW.Dataflow.FlowGraph)this.RootElement;
			...
			{
				global::NBNW.Dataflow.DataflowDiagram diagram = diagrams[0] as global::NBNW.Dataflow.DataflowDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::NBNW.Dataflow.DataflowSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::NBNW.Dataflow.DataflowSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::NBNW.Dataflow.DataflowSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::NBNW.Dataflow.FlowGraph modelRoot = this.RootElement as global::NBNW.Dataflow.FlowGraph;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::NBNW.Dataflow.DataflowSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
