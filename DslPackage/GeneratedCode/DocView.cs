...
namespace NBNW.Dataflow
{
	...
	/// </summary>
	internal partial class DataflowDocView : DataflowDocViewBase
	{
		/// <summary>
		/// Constructs a new DataflowDocView.
		/// </summary>
		public DataflowDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DataflowDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DataflowDocView.
		/// </summary>
		protected DataflowDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DataflowDocDataBase docData = this.DocData as DataflowDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DataflowDocViewBase should be an DataflowDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::NBNW.Dataflow.DataflowDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::NBNW.Dataflow.DataflowDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::NBNW.Dataflow.DataflowToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::NBNW.Dataflow.DataflowToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DataflowDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::NBNW.Dataflow.DataflowHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::NBNW.Dataflow.DataflowHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::NBNW.Dataflow.DataflowHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
