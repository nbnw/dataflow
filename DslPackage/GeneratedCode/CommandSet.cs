...
namespace NBNW.Dataflow
{
	...
	/// </summary>
	internal partial class DataflowCommandSet : DataflowCommandSetBase
	{
		/// <summary>
		/// Constructs a new DataflowCommandSet.
		/// </summary>
		public DataflowCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DataflowCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DataflowCommandSetBase.
		/// </summary>
		protected DataflowCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDataflowExplorerCommand,
				typeof(DataflowEditorFactory).GUID);
		...
		{
			DataflowExplorerToolWindow explorer = this.DataflowExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentDataflowDocData != null && this.CurrentDataflowDocData.Store != null)
			{
				this.CurrentDataflowDocData.ValidationController.Validate(this.CurrentDataflowDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentDataflowDocData != null && this.CurrentDataflowDocData.Store != null)
			{
				...
				this.CurrentDataflowDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected DataflowDocData CurrentDataflowDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DataflowDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DataflowDocView CurrentDataflowDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DataflowDocView;
			}
		}
		...
		/// </summary>
		protected DataflowExplorerToolWindow DataflowExplorerToolWindow
		{
			get
			{
				DataflowExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DataflowExplorerToolWindow), true) as DataflowExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DataflowExplorerToolWindow explorerWindow = this.DataflowExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DataflowClipboardCommandSet : DataflowClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DataflowClipboardCommandSet.
		/// </summary>
		public DataflowClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DataflowClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DataflowClipboardCommandSetBase.
		/// </summary>
		protected DataflowClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
