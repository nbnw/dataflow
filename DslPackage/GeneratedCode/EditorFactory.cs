...
namespace NBNW.Dataflow
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DataflowEditorFactoryId)]
	internal partial class DataflowEditorFactory : DataflowEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DataflowEditorFactory.
		/// </summary>
		public DataflowEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DataflowEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DataflowEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DataflowDocData(this.ServiceProvider, typeof(DataflowEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DataflowDocView(docData, this.ServiceProvider);
		}
	}
}
