...
using DesignerExtensionEnablement = global::NBNW.Dataflow.ExtensionEnablement;
...
namespace NBNW.Dataflow
{
	...
	/// </summary>
	internal abstract partial class DataflowDocDataBase
	{
		/// <summary>
		...
		partial void SetValidationExtensionRegistrar(DslValidation::ValidationController validationController)
		{
			if (validationController != null)
			{
				...
				if (compositionService != null)
				{
					...
					validationController.ValidationExtensionRegistrar = new DesignerExtensionEnablement::DataflowValidationExtensionRegistrar();
