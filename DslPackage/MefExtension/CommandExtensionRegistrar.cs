...
{ 
	...
	/// </summary>	
	internal abstract class DataflowCommandExtensionRegistrarBase : ExtensionEnablement::CommandExtensionRegistrar
	{
		private readonly global::System.Guid commandSetGuid = new global::System.Guid(Constants.DataflowCommandSetId);		
		...
		protected override global::System.String MetadataFilter
		{
			get
			{
				return global::NBNW.Dataflow.ExtensionEnablement.DataflowExtensionFilter.MefMetadataFilter;
			}
		}
	...
	/// </remarks>	
	internal partial class DataflowCommandExtensionRegistrar : DataflowCommandExtensionRegistrarBase
	{		
	}
}  