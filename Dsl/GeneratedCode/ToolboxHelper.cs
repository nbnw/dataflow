...
namespace NBNW.Dataflow
{
	...
	/// </remarks>
	public partial class DataflowToolboxHelper : DataflowToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DataflowToolboxHelper.
		/// </summary>
		public DataflowToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DataflowToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Dataflow toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Dataflow.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DataflowToolboxHelperBase.
		/// </summary>
		protected DataflowToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::NBNW.Dataflow.DataflowDomainModel.SingletonResourceManager.GetString("DataflowToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "NBNW.Dataflow.TaskToolboxItem":
					// Add Task shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.TaskToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"NBNW.Dataflow.DataflowToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DataflowToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.Task.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.StartPointToolboxItem":
					// Add StartPoint shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.StartPointToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.StartPoint.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.EndPointToolboxItem":
					// Add EndPoint shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.EndPointToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.Endpoint.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.MergeBranchToolboxItem":
					// Add MergeBranch shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.MergeBranchToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.MergeBranch.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.SynchronizationToolboxItem":
					// Add Synchronization shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.SynchronizationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.Synchronization.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.FlowToolboxItem":

					// Add Flow connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.FlowToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "NBNW.Dataflow.ObjectInStateToolboxItem":
					// Add ObjectInState shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.ObjectInStateToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.ObjectInState.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.CommentToolboxItem":
					// Add Comment shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.CommentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "NBNW.Dataflow.CommentSubjectsToolboxItem":

					// Add CommentSubjects connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.CommentSubjectsToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "NBNW.Dataflow.ActorToolboxItem":
					// Add Actor shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"NBNW.Dataflow.ActorToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::NBNW.Dataflow.Actor.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::NBNW.Dataflow.DataflowDomainModel));
