...
namespace NBNW.Dataflow
{
	...
	/// </remarks>
	public partial class DataflowHelpKeywordHelper : DataflowHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DataflowHelpKeywordHelper.
		/// </summary>
		protected DataflowHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DataflowHelpKeywordHelper.
		/// </summary>
		public static DataflowHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DataflowHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DataflowHelpKeywordHelperBase.
		/// </summary>
		protected DataflowHelpKeywordHelperBase()
			: base() { }
